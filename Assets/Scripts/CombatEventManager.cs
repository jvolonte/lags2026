...
public static class CombatEventManager
{
    ...
    public static event Action<string, Color, Color> OnPlayDialogue;
    ...
    public static void PlayDialogue(string message, Color bgColor, Color txtColor) => 
        OnPlayDialogue?.Invoke(message, bgColor, txtColor);
